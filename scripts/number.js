...
const score = 5;
const money = 1000.5;
console.log(typeof score); // kiểm tra kiểu dữ liệu của biến => sử dụng `typeof variable`
const bigNumber = "10.12340";
...
const randomTo10 = Math.random() * 10; // random 0 -> 10
console.log(Math.floor(randomTo10)); // trả về một số ngẫu nhiên từ 0 -> 9
// 5 - 10
const max = 10;
const min = 5;
const randomRange = Math.floor(Math.random() * (max - min) + min); // Math.floor() làm tròn xuống số nguyên gần nhất, kết quả là một số nguyên trong khoảng {5, 9}
const decimal = 9.73148;
